...
namespace Rain_On_Your_Parade
{
    ...
    public class LoseScreen
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            //Score
            string score = "Oh no! You ran out of time!";
            spriteBatch.DrawString(font, "You Lose!", new Vector2(GameEngine.SCREEN_WIDTH / 2 - 250, GameEngine.SCREEN_HEIGHT / 2 - 80), Color.White, 0, new Vector2(0, 0), 1f, SpriteEffects.None, 0);
            ...
            for (int i = 0; i < OPTION_NUM; i++)
            {
                ...
                string button_text = (i == 0) ? "Replay" : "Main Menu";
