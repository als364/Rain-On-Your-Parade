        ...
        public Canvas(int level)
        {
            ...
            switch (level)
            {
                ...
                case 8:
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.SunnyRainbowSpot, new Point(0, 9), 0));
                    objects.Add(new WorldObject(ObjectType.Type.SunnyRainbowSpot, new Point(4, 9), 0));
