        ...
        public Canvas(int level)
        {
            ...
            switch (level)
            {
                ...
                case 2:
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(3, 4), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(3, 5), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(3, 6), 0));
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 3), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 4), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 5), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 6), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(6, 3), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(6, 4), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(6, 5), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(6, 6), 0));
                ...
                case 3:
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Pool, new Point(7, 2), 0));
                ...
                case 4:
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Pool, new Point(9, 4), 0));
                ...
                case 5:
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(2, 1), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(2, 2), 0));
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 5), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 6), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 7), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 8), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(5, 9), 0));

                    //flower 6,6 7,7 7,8 8,6
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(6, 6), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(7, 7), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(7, 8), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(8, 6), 0));

                    //flower 9,6 to 9,9
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(9, 6), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(9, 7), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(9, 8), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(9, 9), 0));
                ...
                case 6:
                    ...
                    //cat 0,0 and 9,9
                    actors.Add(new Actor(ActorType.Type.Cat, new Point(0, 0)));
                ...
                case 7:
                    ...
                    //mom 0,0 and 9,9
                    actors.Add(new Actor(ActorType.Type.Mom, new Point(0, 0)));
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(0, 5), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(1, 5), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(8, 4), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Garden, new Point(9, 4), 0));
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Chalking, new Point(6, 0), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Chalking, new Point(3, 3), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Chalking, new Point(6, 6), 0));
                    ...
                    objects.Add(new WorldObject(ObjectType.Type.Sidewalk, new Point(3, 1), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Sidewalk, new Point(3, 2), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Sidewalk, new Point(4, 0), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Sidewalk, new Point(5, 0), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Sidewalk, new Point(7, 0), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Sidewalk, new Point(8, 0), 0));
                    objects.Add(new WorldObject(ObjectType.Type.Sidewalk, new Point(9, 0), 0));
