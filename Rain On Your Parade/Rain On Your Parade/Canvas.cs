...
namespace Rain_On_Your_Parade
{
    class Canvas
    {
        ...
        public Canvas()
        {
            ...
            canvasGrid[1, 1] = new GridSquare(new List<WorldObject>() { new WorldObject(new ObjectType(ObjectType.TypeName.SunnySpot, true, 3, 1, 0, 0), new Vector2(1 * SQUARE_SIZE, 1 * SQUARE_SIZE)) }, new List<Actor>(), true, new Point(1, 1));
            canvasGrid[4, 1] = new GridSquare(new List<WorldObject>() { new WorldObject(new ObjectType(ObjectType.TypeName.Laundry, true, 1, 1, 1, 1), new Vector2(4 * SQUARE_SIZE, 1 * SQUARE_SIZE)) }, new List<Actor>(), true, new Point(4, 1));
            canvasGrid[8, 1] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(8, 1));
            canvasGrid[9, 1] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(9, 1));
            canvasGrid[2, 8] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(2, 8));
            canvasGrid[9, 2] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(9, 2));
            ...
            canvasGrid[3, 2] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(3, 2));
            canvasGrid[4, 2] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(4, 2));
            canvasGrid[3, 3] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(3, 3));
            canvasGrid[4, 3] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(4, 3));
            ...
            canvasGrid[2, 6] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(2, 6));
            canvasGrid[3, 6] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(3, 6));
            canvasGrid[4, 6] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(4, 6));
            canvasGrid[6, 6] = new GridSquare(new List<WorldObject>(), new List<Actor>() { /*new Actor(new ActorType(ActorType.Type.Mom, 0, 0, 0, 0, 0, 0, 0), new Vector2(6*SQUARE_SIZE, 6*SQUARE_SIZE), 0, new ActorState(ActorState.AState.Nurture))*/ }, true, new Point(6, 6));
            canvasGrid[8, 5] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(8, 5));
            canvasGrid[9, 5] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(9, 5));
            canvasGrid[8, 6] = new GridSquare(new List<WorldObject>(), new List<Actor>(), false, new Point(8, 6));
